...
exports.reviews = exports.experiences = exports.mySocials = exports.myProjects = void 0;
// ---------- Data ----------
exports.myProjects = [
    {
        id: 1,
        title: "Automated Portfolio Deployment (DevOps Pipeline)",
        description: "Custom File Storage Application",
        subDescription: [
    ...
    },
    {
        ...
        description: "Solo developing a single-player game with advanced mechanics, including cover, inventory, weapon, and movement systems.",
        subDescription: [
    ...
    },
    {
        id: 5,
        title: "Arcade Game",
        description: "UI/UX + real-time features project.",
        subDescription: [
