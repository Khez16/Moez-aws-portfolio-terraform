...
const ParallaxBackground = () => {
    ...
    const mountain3Y = useTransform(x, [0,0.5], ["0%", "70%"]); {/*when you scroll y progress is at 0 mountain3y will be at 0% 
                                                                                 when you scroll y progress is at 0.5 mountain3y will be at 70%   */}
